class svens_wiring:
    ...
    Sven also copied the setColorBy1DCoordinates from the comment of Timo https://github.com/bk1285/rpi_wordclock/issues/3
    11x11 matrix modified led_count and 2x the minutes mapping
