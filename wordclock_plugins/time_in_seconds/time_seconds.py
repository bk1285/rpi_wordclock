...
class time_seconds:
    ...
    def __init__(self):
        self.leftDigit=[range(23,26) + range(33,34) + range(37,38) + range(44,45) + range(47,49) + range(55,56) + range(57,58) + range(59,60) + range(66,68) + range(70,71) + range(77,78) + range(81,82) + range(89,92), \
            ...
            range(25,24) + range(35,37) + range(45,46) + range(47,48) + range(55,56) + range(58,59) + range(66,71) + range(80,81) + range(91,92), \
            range(44,48), \
    ...
    def get_time(self, time, prev):
        decimal=time.second/10
	ones=time.second%10
	rightDigit = []
	for i in leftDigit[ones]:
		rightDigit.insert(i, i+6)
        # Assemble indices
        return  \
